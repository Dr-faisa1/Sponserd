...
const rewards = [
  // المكافآت الشائعة
  { name: "بطاطس ليز جبن 🍟🧀", rarity: "common", chance: 15 },
  { name: "بطاطس ليز حار 🍟🌶️", rarity: "common", chance: 15 },
  { name: "بطاطس تشيتوس🍟🍅", rarity: "common", chance: 15 },
  { name: "اشرب كأس حليب أو أكل ملعقة عسل أو تمرة", rarity: "common", chance: 10 },
